...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Automate 1Password SSO configuration with Google Cloud')
    
    parser.add_argument('--project-id', required=True, help='GCP Project ID')
    parser.add_argument('--region', default='us-central1', help='GCP Region (default: us-central1)')
    parser.add_argument('--service-account-name', default='scim-bridge-sa', help='Service Account Name for SCIM Bridge')
    parser.add_argument('--scim-bridge-image', default='1password/scim-bridge:latest', help='SCIM Bridge Docker Image')
    parser.add_argument('--domain', required=True, help='Your domain name (e.g., example.com)')
    parser.add_argument('--service-account-file', required=True, help='Path to service account key file')
    parser.add_argument('--admin-email', required=True, help='Admin email for Google Workspace delegation')
